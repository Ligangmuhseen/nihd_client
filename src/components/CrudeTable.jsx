        ...
        <table id="example1" className="table table-bordered table-striped dataTable no-footer dtr-inline" aria-describedby="example1_info">
          ...
          <tbody>
            <tr className="odd">
              ...
              <td className="text-center py-0 align-middle">
                <div className="btn-group btn-group-sm">
                  ...
                  <a href="https://costech.or.tz/editWelcome/1" className="btn btn-secondary" style={{ margin: "0 5px" }}>
                    <i className="fas fa-edit"></i>
                  </a>

                  <a href="https://costech.or.tz/deleteWelcome/1" className="btn btn-danger" style={{ margin: "0 5px" }}>
            ...
            <tr className="even">
              ...
              <td className="text-center py-0 align-middle">
                <div className="btn-group btn-group-sm">
                  <a href="https://costech.or.tz/viewWelcome/2" className="btn btn-primary">
                    <i className="fas fa-eye">
                    </i>
                  </a>
                </div>
            ...
            <tr className="odd">
              ...
              <td className="text-center py-0 align-middle">
                <div className="btn-group btn-group-sm">
                  <a href="https://costech.or.tz/viewWelcome/3" className="btn btn-primary">
                    <i className="fas fa-eye">
                    </i>
                  </a>
                </div>
