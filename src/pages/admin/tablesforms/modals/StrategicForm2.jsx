...
const StrategicForm2 = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_BASE_URL}/strategictwo/upload/${id}/`)
      .then((response) => {
        const { data } = response;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API_BASE_URL}/strategictwo/upload/${id}/`, formData, {
        headers: {
  ...
  return (
    <div>
      <div className="modal fade" id="strategicmodal2" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
