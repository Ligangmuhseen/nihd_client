            ...
            <tr className="odd">
              ...
              <td className="text-center py-0 align-middle">
                <div className="btn-group btn-group-sm">
                  <a href="#" className="btn btn-primary" style={{ margin: "0 5px" }}>
                    <i className="fas fa-eye">
                    </i>

                  </a>

                  <a href="#" className="btn btn-secondary" style={{ margin: "0 5px" }}>
                    <i className="fas fa-edit"></i>
                  </a>

                  <a href="#" className="btn btn-danger" style={{ margin: "0 5px" }}>
