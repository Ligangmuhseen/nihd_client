                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-right">
                            ...
                            <Link to="serviceform" ><button class="btn btn-primary" data-toggle="modal" data-target="#servicemodal">Add New</button></Link>
                                                ...
                                                <tr className="odd">
                                                    ...
                                                    <td className="text-center py-0 align-middle">
                                                        <div className="btn-group btn-group-sm">
                                                            ...
                                                            <Link to="serviceform2" className="btn btn-secondary" data-toggle="modal" data-target="#servicemodal2"style={{ margin: "0 5px" }}>
                                                                <i className="fas fa-edit"></i>
                                                            </Link>

                                                            <Link to="serviceform3" className="btn btn-danger"data-toggle="modal" data-target="#servicemodal3" style={{ margin: "0 5px" }}>
