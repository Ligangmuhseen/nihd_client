                ...
                <tr className="odd" key={item.id}>
                  ...
                  <td className="text-center py-0 align-middle">
                    <div className="btn-group btn-group-sm">
                      <Link to={`strategicform2/${item.id}`}>
                        <button className="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#strategicmodal2" style={{ margin: "0 5px" }}>
