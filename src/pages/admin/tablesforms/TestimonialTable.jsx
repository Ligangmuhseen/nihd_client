                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-right">
                            ...
                            <Link to="testimonialsform" ><button class="btn btn-primary" data-toggle="modal" data-target="#testimonialsmodal">Add New</button></Link>
                            HeroForm
HeroForm
HeroForm
                                            ...
                                            <tr className="odd">
                                                ...
                                                <td className="text-center py-0 align-middle">
                                                    <div className="btn-group btn-group-sm">
                                                        <a href="testimonialsform" className="btn btn-primary" data-toggle="modal" data-target="#testimonialsmodal" style={{ margin: "0 5px" }}>
                                                            <i className="fas fa-eye">
                                                            </i>

                                                        </a>

                                                        <Link to="testimonialsform2" className="btn btn-secondary" data-toggle="modal" data-target="#testimonialsmodal2" style={{ margin: "0 5px" }}>
                                                            <i className="fas fa-edit"></i>
                                                        </Link>

                                                        <Link to="testimonialsform3" className="btn btn-danger" data-toggle="modal" data-target="#testimonialsmodal3" style={{ margin: "0 5px" }}>
